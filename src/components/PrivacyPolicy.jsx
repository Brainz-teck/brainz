...
function PrivacyPolicy() {
  return (
    <div>
      <h5 className={`${styles.heading2}`}>Privacy Policy</h5>
      <p>Last updated: April 27, 2024</p> <br />
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>For other purposes</strong>: <br />
      ...
      <ul>
        ...
        <li>
          <strong>With Your consent</strong>: <br /> We may disclose Your
      ...
      <ul>
        <li>
          <p>By email: support@brainz.freshdesk.com</p>
        </li>
        <li>
          <p>
